...
namespace TimemicroCore.CoinsWallet.Litecoin.Service.Impl
{
    public class SendNotifyServiceImpl : ISendNotifyService
    {
        ...
        public void Notify()
        {
            ...
            var result = new LTCSendNotifyResult()
            {
                Data = new List<LTCSendNotifyResultDataItem>()
            };
            ...
            var http = WebRequest.CreateHttp(configuration["CoinsWallet:Litecoin:SendNotifyUrl"]);
            try
            {
