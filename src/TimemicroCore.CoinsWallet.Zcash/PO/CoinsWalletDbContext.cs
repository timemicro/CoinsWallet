...
namespace TimemicroCore.CoinsWallet.Zcash.PO
{
    public class CoinsWalletDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("ZEC_RECEIVEADDRESSES");
            ...
            {
                entity.ToTable("ZEC_TRANSACTIONS");
            ...
            {
                entity.ToTable("ZEC_TRANSACTIONDETAILS");
            ...
            {
                entity.ToTable("ZEC_RECEIVENOTIFYLOGS");
                entity.HasKey(x => x.Id);
                entity.Property(x => x.TxId).HasColumnName("TXID");
                entity.Property(x => x.Address).HasColumnName("ADDRESS");
                entity.Property(x => x.Amount).HasColumnName("AMOUNT");
            ...
            {
                entity.ToTable("ZEC_SENDREQUESTS");
                entity.HasKey(x => x.Id);
                entity.Property(x => x.Id).HasColumnName("ID");
