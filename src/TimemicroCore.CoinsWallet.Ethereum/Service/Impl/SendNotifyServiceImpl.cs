...
namespace TimemicroCore.CoinsWallet.Ethereum.Service.Impl
{
    public class SendNotifyServiceImpl : ISendNotifyService
    {
        ...
        public void Notify()
        {
            ...
            var result = new ETHSendNotifyResult()
            {
                Data = new List<ETHSendNotifyResultDataItem>()
            };
            ...
            var http = WebRequest.CreateHttp(configuration["CoinsWallet:ethereum:SendNotifyUrl"]);
            try
            {
