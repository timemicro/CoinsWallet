...
namespace TimemicroCore.CoinsWallet.Quartz.BitcoinCash
{
    ...
    public class BCHSendNotifyQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(BCHSendNotifyQuartzJob));
