...
namespace TimemicroCore.CoinsWallet.Quartz.Ethereum
{
    ...
    public class ETHSendNotifyQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(ETHSendNotifyQuartzJob));
