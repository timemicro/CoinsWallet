...
namespace TimemicroCore.CoinsWallet.Quartz.Ethereum
{
    ...
    public class ETHReceiveNotifyQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(ETHReceiveNotifyQuartzJob));
        ...
        public Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                var req = new ETHReceiveNotifyReq();
