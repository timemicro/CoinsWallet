...
namespace TimemicroCore.CoinsWallet.Quartz.Bitcoin
{
    ...
    public class BTCSendNotifyQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(BTCSendNotifyQuartzJob));
