...
namespace TimemicroCore.CoinsWallet.Quartz.Dash
{
    ...
    public class DASHReceiveNotifyQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(DASHReceiveNotifyQuartzJob));
        ...
        public Task Execute(IJobExecutionContext context)
        {
            try
            {
                var req = new DASHReceiveNotifyReq();
