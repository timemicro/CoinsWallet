...
namespace TimemicroCore.CoinsWallet.Quartz.Dash
{
    ...
    public class DASHSyncTransactionQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(DASHSyncTransactionQuartzJob));
        ...
        public Task Execute(IJobExecutionContext context)
        {
            try
            {
                var req = new DASHSyncTransactionReq();
