...
namespace TimemicroCore.CoinsWallet.Quartz.Dash
{
    ...
    public class DASHSyncBlockQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(DASHSyncBlockQuartzJob));
