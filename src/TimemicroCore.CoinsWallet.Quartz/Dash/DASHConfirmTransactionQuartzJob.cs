...
{
    public class DASHConfirmTransactionQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(DASHConfirmTransactionQuartzJob));
        ...
        public Task Execute(IJobExecutionContext context)
        {
            try
            {
                var req = new DASHConfirmTransactionReq();
