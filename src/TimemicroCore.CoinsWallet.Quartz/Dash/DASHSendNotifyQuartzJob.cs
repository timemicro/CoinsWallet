...
namespace TimemicroCore.CoinsWallet.Quartz.Dash
{
    ...
    public class DASHSendNotifyQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(DASHSendNotifyQuartzJob));
