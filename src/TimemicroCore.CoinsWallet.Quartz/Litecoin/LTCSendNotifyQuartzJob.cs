...
namespace TimemicroCore.CoinsWallet.Quartz.Litecoin
{
    ...
    public class LTCSendNotifyQuartzJob : IJob
    {
        static ILog logger = LogManager.GetLogger("NETCoreRepository", typeof(LTCSendNotifyQuartzJob));
